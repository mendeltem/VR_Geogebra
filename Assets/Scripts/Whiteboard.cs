...
namespace Picasso
{
    ...
    public class Whiteboard : MonoBehaviour
    {
        ...
        public List<MeshGenerator> Surfaces;
        ...
        private void Update()
        {
                ...
                out PrimaryButtonValue) && PrimaryButtonValue)
            {
                ...
                if (currentSurface != null){
                    ...
                    currentSurface.exists = 0;

                    for(int i = 0; i < currentSurface.points.Count; i++){
                            currentSurface.points[i].GetComponent<MeshRenderer>().enabled = false;
                    };
        ...
        private void Pyramid()
        {
                    ...
                    out TriggerButtonValue) && TriggerButtonValue)
            {
                ...
                if (!IsPressed)
                {
                    ...
                    if(index == 1){
                        ...
                        currentSurface.type_of_object= "pyramid";
                        currentSurface.exists = 1;
                        currentSurface.transform.parent = SurfaceParent;
                        currentSurface.verts.Clear();
                        currentSurface.points.Clear();
            ...
            else if (IsPressed)
            {
                ...
                if (currentSurface != null){
                    currentSurface.index = currentSurface.index + 1;
                    index = currentSurface.index;

                }
                if (currentSurface != null){
                    if (currentSurface.verts.Count > 4){
                    ...
                    out TriggerButtonValue) && TriggerButtonValue)
            {
                ...
                if (!IsPressed)
                {
                    ...
                    if(index == 1){
                        ...
                        currentSurface.type_of_object= "surface";
